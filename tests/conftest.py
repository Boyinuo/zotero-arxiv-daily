    ...
    with initialize_config_dir(config_dir=_CONFIG_DIR, version_base=None):
        cfg = compose(
            ...
            overrides=[
                ...
                "reranker.api_embedding.key=sk-fake",
                "reranker.api_embedding.base_url=http://localhost:30000/v1",
                "reranker.api_embedding.model=text-embedding-3-large",
                "source.arxiv.category=[cs.AI,cs.CV]",
                "executor.source=[arxiv]",
                "executor.reranker=api_embedding",
